...
class Skill {
    ...
    public:
        ...
        //     std::cout << "Ratio Player Attack\t: " << _ratioPlayerAtk <<
        //     std::endl; std::cout << "Pierce Rate\t: " << _pierceRate <<
        //     std::endl;
        // }
...
// Skill fireball("Fireball", 10, 5, 20, 1.25f, 5); // The fireball skill of the
// entity Skill iceSpike("Ice Spike", 15, 7, 25, 1.5f, 10); // The ice spike skill
// of the entity Skill lightningBolt("Lightning Bolt", 20, 10, 30, 2.0f, 15); //
// The lightning bolt skill of the entity Skill fireStorm("Fire Storm", 25, 15,
// 20, 3.0f, 20); // The fire storm skill of the entity Skill thunderStorm("Thunder
// Storm", 30, 20, 25, 4.0f, 25); // The thunder storm skill of the entity Skill
// meteor("Meteor", 35, 25, 30, 5.0f, 30); // The meteor skill of the entity

// Skill ledExplosion("LED Explosion", 10, 2, 30, 0.5f, 0); // The LED explosion
// skill of the entity Skill capacitorExplosion("Capacitor Explosion", 45, 35,
// 40, 7.0f, 40); // The capacitor explosion skill of the entity Skill
// resistorExplosion("Resistor Explosion", 50, 40, 50, 8.0f, 45); // The resistor
// explosion skill of the entity Skill diodeExplosion("Diode Explosion", 55, 45,
// 60, 9.0f, 50); // The diode explosion skill of the entity Skill
// transistorExplosion("Transistor Explosion", 60, 50, 70, 10.0f, 55); // The
// transistor explosion skill of the entity Skill
// microcontrollerExplosion("Microcontroller Explosion", 65, 55, 80, 11.0f, 60); //
// The microcontroller explosion skill of the entity Skill hotLine("Hot Line", 70,
// 60, 90, 12.0f, 65); // The hot line skill of the entity

// Skill iDontBuyIt("I Don't Buy It", 0, 0, 0, 0.0f, 0); // The iDontBuyIt skill of
// the entity
